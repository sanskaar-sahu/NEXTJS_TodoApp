        ...
        return (
            <>  
                ...
                <form  onSubmit={onSubmitHandle}   className="m-5 self-center items-center justify-center p-3 flex flex-col ">
                    <input  value={formData.fullname}  type="text" name="fullname" onChange={onChangeHandle} placeholder="Enter your name" className="px-3 m-2 py-2 border-2 border-gray-700 ouline-none" />
                    ...
                    <button type="submit" className="bg-blue-500 text-white px-3 py-2 rounded-lg justify-self-start" >SignUp</button>
                </form>
            </>
        )
    }
